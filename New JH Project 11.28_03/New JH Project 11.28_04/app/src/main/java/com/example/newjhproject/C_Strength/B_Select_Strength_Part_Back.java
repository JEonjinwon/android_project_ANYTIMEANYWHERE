...
public class B_Select_Strength_Part_Back extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cb_select_strength_part_back);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (R_group.getCheckedRadioButtonId()) {
                    case R.id.btn1:
                        img.setImageResource(R.drawable.back2);
                        break;
                    case R.id.btn2:
                        img.setImageResource(R.drawable.back3);
                        break;
                    case R.id.btn3:
                        img.setImageResource(R.drawable.back4);
                        break;
                    case R.id.btn4:
                        img.setImageResource(R.drawable.back5);
                        break;
                    case R.id.btn5:
                        img.setImageResource(R.drawable.back6);
                        break;
                    case R.id.btn6:
                        img.setImageResource(R.drawable.back7);
                        break;
                }
            }
        });
