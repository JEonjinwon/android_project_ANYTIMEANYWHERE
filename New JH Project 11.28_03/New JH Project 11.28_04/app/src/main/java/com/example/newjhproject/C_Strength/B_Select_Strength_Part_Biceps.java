...
public class B_Select_Strength_Part_Biceps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cb_select_strength_part_biceps);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (R_group.getCheckedRadioButtonId()) {
                    case R.id.btn1:
                        img.setImageResource(R.drawable.biceps2);
                        break;
                    case R.id.btn2:
                        img.setImageResource(R.drawable.biceps3);
                        break;
                    case R.id.btn3:
                        img.setImageResource(R.drawable.biceps4);
                        break;
                    case R.id.btn4:
                        img.setImageResource(R.drawable.biceps5);
                        break;
                    case R.id.btn5:
                        img.setImageResource(R.drawable.biceps6);
                        break;
                    case R.id.btn6:
                        img.setImageResource(R.drawable.biceps7);
                        break;
                }
            }
        });
