...
public class B_Select_Strength_Part_Triceps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cb_select_strength_part_triceps);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (R_group.getCheckedRadioButtonId()) {
                    case R.id.btn1:
                        img.setImageResource(R.drawable.triceps2);
                        break;
                    case R.id.btn2:
                        img.setImageResource(R.drawable.triceps3);
                        break;
                    case R.id.btn3:
                        img.setImageResource(R.drawable.triceps4);
                        break;
                    case R.id.btn4:
                        img.setImageResource(R.drawable.triceps5);
                        break;
                    case R.id.btn5:
                        img.setImageResource(R.drawable.triceps6);
                        break;
                    case R.id.btn6:
                        img.setImageResource(R.drawable.triceps7);
                        break;
                }
            }
        });
