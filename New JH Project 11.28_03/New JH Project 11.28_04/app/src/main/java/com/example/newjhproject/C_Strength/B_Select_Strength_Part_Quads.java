...
public class B_Select_Strength_Part_Quads extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cb_select_strength_part_quads);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (R_group.getCheckedRadioButtonId()) {
                    case R.id.btn1:
                        img.setImageResource(R.drawable.quads2);
                        break;
                    case R.id.btn2:
                        img.setImageResource(R.drawable.quads3);
                        break;
                    case R.id.btn3:
                        img.setImageResource(R.drawable.quads4);
                        break;
                    case R.id.btn4:
                        img.setImageResource(R.drawable.quads5);
                        break;
                    case R.id.btn5:
                        img.setImageResource(R.drawable.quads6);
                        break;
                    case R.id.btn6:
                        img.setImageResource(R.drawable.quads7);
                        break;
                }
            }
        });
